...
addBtn.addEventListener('click', () => {
    ...
    if(transactionId.value === '' || transactionName.value === '' || transactionAmount.value === '' || transactionDate.value === '' || transactionCategory.value === ''){
        ...
        li.innerHTML = `
            ...
            <span class="edit edit-btn-${transactionId.value}" data-id="${transactionId.value}"><img src="images/edit.png" class="edit-img"/></span>
...
function showTask(){
    ...
    data.forEach((item) => {
        ...
        li.innerHTML = `
            ...
            <div>${item.date}</div>
            <span class="edit"><img src="images/edit.png" class="edit-img edit-btn-${item.id}" data-id="${item.id}"/></span>
...
editSubmitBtn.addEventListener('click',  () => {
    ...
    itemToEditDiv.innerHTML = `
        ...
        <span class="edit"><img src="images/edit.png" class="edit-img edit-btn-${itemToEdit.id}" data-id="${itemToEdit.id}"/></span>
